...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
{
  ...
  # PrimaryKeyFeature <- Meta_Features %>% filter(TableName_Curated == "Department", IsPrimaryKey == TRUE) %>% pull(FeatureName_Curated)
  # DiscriminatoryFeatures <- Meta_Features %>% filter(TableName_Curated == "Department", IsDiscriminatory == TRUE) %>% pull(FeatureName_Curated)
  # EssentialFeatures <- Meta_Features %>% filter(TableName_Curated == "Department", IsEssential == TRUE) %>% pull(FeatureName_Curated)
